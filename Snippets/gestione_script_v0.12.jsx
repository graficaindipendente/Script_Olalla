...
var dialog = new Window("dialog", "Operazioni di Messa in Stampa Pronto 13");
dialog.alignChildren = "left"; // Allinea tutti i figli a sinistra

// Aggiunge un pannello di script con caselle di controllo
var scriptPanel = dialog.add("panel", undefined, "Saranno eseguite le seguenti operazioni:");
...
var okButton = buttonGroup.add("button", undefined, "Esegui");
