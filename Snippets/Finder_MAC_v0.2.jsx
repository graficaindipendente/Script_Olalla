...
function selectFile(files) {
    ...
    var listBox = dialog.add('listbox', undefined, files.map(function(file) { return decodeURIComponent(file.name); }));
...
// Percorso della cartella per macOS
var folderPath = '/Users/alessandropiovan/Downloads';
